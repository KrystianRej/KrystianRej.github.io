$(document).ready(function() {
  const apiRoot = 'https://sheltered-woodland-78631.herokuapp.com/v1/';
  const trelloApiRoot = 'https://sheltered-woodland-78631.herokuapp.com/v1/trello/';
  ...
  function handleTaskDeleteRequest() {
    ...
    $.ajax({
      url: requestUrl + '/{taskId}?taskId=' + taskId,
      method: 'DELETE',
      success: function() {
